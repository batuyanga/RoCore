...
char rev_nr_file[MAX_PATH] = "src/server/shared/revision_nr.h";
char rev_sql_file[MAX_PATH] = "src/server/shared/revision_sql.h";
char sql_update_dir[MAX_PATH] = "sql/wow_ro";
