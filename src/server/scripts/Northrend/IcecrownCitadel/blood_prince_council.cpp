...
CreatureAI* GetAI_lanathel_intro(Creature* pCreature)
{
...
void AddSC_boss_blood_council()
{
    ...
    newscript = new Script;
    newscript->Name="lanathel_intro";
    newscript->GetAI = &GetAI_lanathel_intro;
    newscript->RegisterSelf();

    newscript = new Script;
    newscript->Name="npc_nucleus_icc";
    newscript->GetAI = &GetAI_npc_Nucleus;
    newscript->RegisterSelf();

    newscript = new Script;
    newscript->Name="npc_fireball_icc";
    newscript->GetAI = &GetAI_npc_Fireball;
    newscript->RegisterSelf();

    newscript = new Script;
    newscript->Name="npc_bomb_icc";
    ...
    newscript = new Script;
    newscript->Name="npc_empfireball_icc";
